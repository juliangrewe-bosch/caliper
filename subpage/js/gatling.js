...
(function ($) {
  ...
  $.fn.expand = function (scope, recursive) {
    return this.each(function () {
      ...
      if (recursive) {
        scope
          .find("*[data-parent=" + $this.attr("id") + "]")
          .find(".expand-button.expand")
          .expand(scope, true);
        scope
          .find("*[data-parent=" + $this.attr("id") + "]")
          .find(".expand-button.expand")
  ...
  $.fn.collapse = function (scope) {
    return this.each(function () {
      ...
      scope
        .find("*[data-parent=" + $this.attr("id") + "] .expand-button.collapse")
        .collapse(scope);
  ...
  $.fn.sortTable = function (col, desc) {
    ...
    function sortLines(lines, group) {
      ...
      var linesToSort = notErrorTable
        ? lines.filter("*[data-parent=" + group + "]")
        : lines;
    ...
    this.find("tbody").append(
      sortLines(this.find("tbody tr").detach(), "ROOT")
    );
